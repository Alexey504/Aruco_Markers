...
# Загрузка матрицы камеры и матрицы искажений
camera_matrix, dist_coeffs = load_coefficients("calibration_data.xml")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if ids is not None:
            ...
            rvecs, tvecs, _ = cv2.aruco.estimatePoseSingleMarkers(corners, 0.2, camera_matrix, dist_coeffs)
            cnt += 0.1
